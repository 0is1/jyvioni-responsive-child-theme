 ...
 */
?>
<?php  // We want to use only two home widgets in Jyvioni-2013 ?>

    <div id="widgets" class="home-widgets">
      <div class="grid col-620">
        <div class="widget-wrapper">
        <?php
          /* Add homepage-posts template */
          get_template_part('homepage', 'posts');
        ?>
      ...
      <?php if (!dynamic_sidebar('home-widget-1')) : ?>
        <div class="widget-title-home"><h3><?php _e('Home Widget 1', 'responsive'); ?></h3></div>
            <div class="textwidget"><?php _e('This is your first home widget box. To edit please go to Appearance > Widgets and choose 6th widget from the top in area 6 called Home Widget 1. Title is also manageable from widgets as well.','responsive'); ?>
            </div>
